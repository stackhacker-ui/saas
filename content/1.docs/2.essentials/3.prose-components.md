...
---
  :::accordion
    ...
    label: What are the main considerations when upgrading to Stackhacker UI v3?
    ---
    ...
    ---
    icon: i-lucide-circle-help
    label: Is Stackhacker UI v3 compatible with standalone Vue projects?
    ---
    Stackhacker UI is now compatible with Vue! You can follow the [installation guide](/docs/getting-started/installation) to get started.
    ::::
  :::
...
:::accordion-item{label="What are the main considerations when upgrading to Stackhacker UI v3?" icon="i-lucide-circle-help"}
The transition to v3 involves significant changes, including new component structures, updated theming approaches, and revised TypeScript definitions. We recommend a careful, incremental upgrade process, starting with thorough testing in a development environment.
:::

:::accordion-item{label="Is Stackhacker UI v3 compatible with standalone Vue projects?" icon="i-lucide-circle-help"}
Stackhacker UI is now compatible with Vue! You can follow the [installation guide](/docs/getting-started/installation) to get started.
:::
...
---
  ...
  target: _blank
  title: Dashboard
  to: https://github.com/stackhacker-ui/dashboard
  ---
...
::code-preview
  :::card-group{.w-full}
    ...
    target: _blank
    title: SaaS
    to: https://github.com/stackhacker-ui/saas
    ---
    ...
    target: _blank
    title: Docs
    to: https://github.com/stackhacker-ui/docs
    ---
    ...
    target: _blank
    title: Landing
    to: https://github.com/stackhacker-ui/landing
    ---
...
---
  :::steps{level="4"}
  #### Add the Stackhacker UI module in your `nuxt.config.ts`
  ...
  #### Import Tailwind CSS and Stackhacker UI in your CSS
...
#### Add the Stackhacker UI module in your `nuxt.config.ts`{lang="ts-type"}
